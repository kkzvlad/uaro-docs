...
![uaRO — World of Your Dream](img/wiki-title.webp){ .wiki-hero }

<div id="index-patch-notes" markdown>
...
!!! note "Patch Notes"
    ...
    === "November 24"
        **November 24, 2025**
        ...
        - Instance Security: Unique ID lock on ET/EC/HTF cooldowns (circumvention = account ban).
